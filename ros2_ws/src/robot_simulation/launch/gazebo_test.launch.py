...
def generate_launch_description():
    ...
    rsp = Node(package='robot_state_publisher', executable='robot_state_publisher', name='robot_state_publisher_sim', parameters=[{'robot_description': description}])
    mux = Node(package='cmd_switcher', executable='cmd_mux_node', name='cmd_switcher_sim', output='screen')
    localization = IncludeLaunchDescription(PythonLaunchDescriptionSource(os.path.join(nav, 'launch', 'localization.launch.py')))
    navigation = IncludeLaunchDescription(PythonLaunchDescriptionSource(os.path.join(nav, 'launch', 'navigation.launch.py')))
